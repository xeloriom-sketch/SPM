...
export const metadata: Metadata = {
  ...
  description:
    "SPM Taxi : chauffeur professionnel conventionné CPAM basé à Villebois (Ain 01). Carte professionnelle, agrément Assurance Maladie, assurance RC pro. Volkswagen Tiguan 7 places. Note Google 4,6/5 sur 12 avis. Disponible 7j/7 24h/24. ☎ 07 67 75 18 98.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Chauffeur professionnel conventionné CPAM, Tiguan 7 places, note 4,6/5 Google. SPM Taxi — Villebois (Ain 01). 7j/7 24h/24.",
