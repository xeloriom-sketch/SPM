      ...
      >
        ...
        <div className="relative h-12 w-full bg-[#f8f9fa] flex justify-center">
          ...
          >
            <a
              href="#services"
              className="flex h-14 w-14 items-center justify-center rounded-full bg-[#111] text-white/50 shadow-xl transition-all hover:scale-110 hover:text-white active:scale-95"
            >
              <motion.div
                animate={{ y: [0, 5, 0] }}
