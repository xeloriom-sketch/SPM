...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/taxi-amberieu-en-bugey/`,                   lastModified: NOW, changeFrequency: "monthly", priority: 0.9  },
    { url: `${BASE}/taxi-meximieux/`,                           lastModified: NOW, changeFrequency: "monthly", priority: 0.8  },
    { url: `${BASE}/taxi-montluel/`,                            lastModified: NOW, changeFrequency: "monthly", priority: 0.8  },
    { url: `${BASE}/carte-de-visite/`,                          lastModified: NOW, changeFrequency: "monthly", priority: 0.6  },
